...
#'   \item{x}{Integer actuarial age, from 0 to 100.}
...
#'   \item{lx}{Number of survivors at exact age \code{x}, based on \code{l0 = 100000}.}
...
#' reconstructed recursively from \code{l0 = 100000}.
#'
